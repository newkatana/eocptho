		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	          ...
	          <span class="sr-only">Toggle Menu</span>
				...
				<div class="p-4">
		  		<h1><a href="index.php" class="logo">EOC-COVID <span>Phatthalung</span></a></h1>
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
                ...
                <li><a href="index.php?page=vaccine-dashboard"><span class=""></span>Dashboard</a></li>
                <li><a href="index.php?page=vaccine-stat"><span class=""></span>ข้อมูลสรุปการฉีดวัคซีน</a></li>
